...
namespace Models
{
    class Piranha : Fish, ICarnivorous
    {
        ...
        private const string PiranhaPictureEating = @"...\...\Resourses\Pictures\PiranhaPicture_02.jpg";
        private const string PiranhaPictureUnhappy =  @"...\...\Resourses\Pictures\PiranhaPicture_03.jpg";
